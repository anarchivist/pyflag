...
config.add_option("scanners", default='HTTPScanner,YahooMailScan,HotmailScanner,MSNScanner,IRCScanner,POPScanner,YahooMail20Scan,GmailScanner,SMTPScanner,FTPScanner,SquirrelMailScan',
