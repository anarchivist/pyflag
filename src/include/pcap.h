...
//STRUCT_INT)
#define PCAP_PKTHEADER_STRUCT FORMAT_INT  FORMAT_INT FORMAT_INT FORMAT_INT

//#define PCAP_PKTHEADER_STRUCT_LE q(STRUCT_INT_LE, STRUCT_INT_LE,
//STRUCT_INT_LE, STRUCT_INT_LE)
#define PCAP_PKTHEADER_STRUCT_LE FORMAT_INT_LE  FORMAT_INT_LE  FORMAT_INT_LE FORMAT_INT_LE
