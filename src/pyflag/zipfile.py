...
This is a modified version of the standard python zip hander with the option of unzipping a file with an incorrect CRC
"""
...
class ZipFile:
    ...
    def _RealGetContents(self):
        ...
        for data in self.filelist:
            ...
            if fname != data.orig_filename:
                print 'File names in directory "%s" and header "%s" differ.' % ( data.orig_filename, fname)
    ...
    def read(self, name):
        ...
        if crc != zinfo.CRC:
            print "Bad CRC-32 for file %s" % name
        return bytes
