...
void
TSK_SHA_Init(TSK_SHA_CTX * shsInfo)
{
...
static void
longReverse(UINT4 * buffer, int byteCount, int Endianness)
{
    UINT4 value;
...
static void
SHAtoByte(BYTE * output, UINT4 * input, unsigned int len)
