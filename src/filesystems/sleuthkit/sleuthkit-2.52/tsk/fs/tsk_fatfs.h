...
#define FATFS_INODE_2_SECT(fatfs, i)    \
    (TSK_DADDR_T)((i - 3)/(fatfs->dentry_cnt_se) + fatfs->firstdatasect)
...
#define FATFS_SECT_2_INODE(fatfs, s)    \
    (TSK_INUM_T)((s - fatfs->firstdatasect) * fatfs->dentry_cnt_se + 3)
...
/* internal FATFS_INFO structure */
    ...
    extern int8_t is_sectalloc(FATFS_INFO *, TSK_DADDR_T);

    extern uint8_t fatfs_dent_walk(TSK_FS_INFO *, TSK_INUM_T,
    ...
    extern TSK_RETVAL_ENUM fatfs_dinode_copy(FATFS_INFO *, TSK_FS_INODE *,
