...
*/
    typedef struct {
        ...
        TSK_FS_INODE *mft_inode;        /* contains the data for the mft entry for the mft */
        TSK_FS_DATA *mft_data;  /* Data run for MFT entry for MFT */
        ...
        TSK_FS_DATA_RUN *bmap;  /* Run of bitmap for clusters (linked list) */
        TSK_DATA_BUF *bmap_buf; /* buffer to hold cached copy of bitmap */
    ...
    extern uint8_t
        ntfs_data_walk(NTFS_INFO *, TSK_INUM_T, TSK_FS_DATA *, int,
        TSK_FS_FILE_WALK_CB, void *);
    extern uint8_t
        ntfs_dent_walk(TSK_FS_INFO *, TSK_INUM_T, TSK_FS_DENT_FLAG_ENUM,
