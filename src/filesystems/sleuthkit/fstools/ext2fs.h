...
/* Journal Info */
    ...
    extern uint8_t ext2fs_dent_walk(TSK_FS_INFO *, INUM_T,
    ...
    extern uint8_t ext2fs_jblk_walk(TSK_FS_INFO *, DADDR_T, DADDR_T, int,
        TSK_FS_JBLK_WALK_CB, void *);
    extern uint8_t ext2fs_jopen(TSK_FS_INFO *, INUM_T);
